...
public class OsmImportparameter {
	...
	/**
	 * set a second language code, if import area has country specific tags, like in south tirol, italy
	 */
	...
	/**
	 * List of extra Osm Keys, which could be in importfile and shall be keep at import address, perhaps to later direct import to osm
	 */
	private List<String> extrakeys = new ArrayList<>();
	...
	/**
	 * set a List of extra Osm Keys, which could be in importfile and shall be keep at import address, perhaps to later direct import to osm
	 * 
	 * @param extrakeys
	 */
	public void setExtrakeys(List<String> extrakeys) {

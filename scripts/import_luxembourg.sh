...
# gebiete_erstellen
java -cp .:/home/hnrtest/apps/housenumbercore/target/classes/main/resources/commons-compress-1.4.jar:/home/hnrtest/apps/housenumbercore/target/classes/main/resources/osmosis-xml--SNAPSHOT.jar:/home/hnrtest/apps/housenumbercore/target/classes/main/resources/osmosis-core--SNAPSHOT.jar:/home/hnrtest/apps/housenumbercore/target/classes/main/resources/postgresql-9.4-1204-jdbc4.jar de/regioosm/housenumbercore/imports/CsvListImport -country "Luxembourg" -coordinatesystem 4326 -subareaactive "n" -listurl "https://lux.xy/de.txt" -copyright "Copyright Lux xyz" -useage "Nutzungsvereinbarung Lux xy" -listcontenttimestamp 2018-03-01 -listfiletimestamp 2018-03-15 -coordinatesosmimportable yes -useoverpass yes  -c 12=municipality -c 3=subarea -c 1=street -c 2=housenumber -c 4=postcode -c 8=lon -c 7=lat -file /home/hnrtest/apps/housenumbercore/data/Luxembourg/luxembourg-addresses-TEST-sortiert.csv >import_Luxembourg-TEST.log 2>&1 &
